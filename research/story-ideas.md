...
- Hook: France has a commune called Y. It also has 3,882 starting with Saint-. And one 45-character name. The address book of 35,014 places.
- Data: DREES APL 2023 commune dataset (reused from medical-deserts story). 35,014 communes with names, INSEE codes, départements, population, and centroid coordinates.
- Angle: Text-and-charts story. Two charts: horizontal bar (top 15 most common names) + length histogram. Hall-of-fame tables for shortest and longest. Three narrative sections: saints, hyphens, uniqueness.
- Draft X summary:
  > France has 35,014 communes. One is called Y. 3,882 start with Saint- or Sainte-. The longest name has 45 characters. Today on **france-data**: the full census of French place names — shortest, longest, most common, and most duplicated. 🇫🇷
