...
- Hook: France has a commune called Y. It also has a commune with a 45-character name. In between: 3,882 saints, 13,410 hyphens, and 32,764 genuinely unique names.
- Data: Derived entirely from the DREES APL 2023 commune dataset already in the repo (communes-apl.geojson). No new downloads. 35,014 commune names analysed for frequency, length, and patterns.
- Angle: Text-and-charts story. Two Chart.js visuals: (1) horizontal bar chart of the 15 most-repeated names; (2) histogram of name lengths. Four narrative beats: scale, saint dominance, hyphen habit, the extremes.
- Draft X summary:
  > France has a commune called Y. One letter. 89 residents. It also has Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson — 45 characters, two saints, born from a 1972 merger where neither village would give up its name. Today on **france-data**: what 35,000 commune names reveal about a country. 🇫🇷
