...
- 🔥 France has a commune called Y. One letter. Population 89. It's in the Somme and it predates the Republic. [Q-039]
- 🔥 3,882 French communes — one in nine — have names starting with Saint- or Sainte-. The evangelisation of Gaul is still visible in the postal code directory. [Q-037]
- 🔥 There are 12 separate communes named Sainte-Colombe in France, spread across 12 different départements, all named after the same martyred Roman saint. None of them are twins. [Q-037]
- 🔥 The longest commune name in France is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 characters, Marne). The shortest is Y (1 character, Somme). Both are real places. [Q-039]
