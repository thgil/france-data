...
- 🔥 France has one commune whose entire name is a single letter: Y. Population 89, Somme. It's been the answer to a trivia question for centuries. [Q-039]
- 🔥 Sainte-Colombe appears 12 times in France — one in each of 12 different départements. You need the INSEE code to know which one you mean. [Q-037]
- 🔥 11.1% of French communes start with Saint- or Sainte-. France ran out of geography and turned to the church. [Q-037]
- 🔥 The longest commune name in France is 45 characters: Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson. It merged with three neighbours and kept all their names. [Q-037]
