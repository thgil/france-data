...
- 🔥 France has a commune called Y. One letter. Population 89. It is the shortest official place name in the world. [Q-039]
- 🔥 3,882 French communes start with Saint- or Sainte-. One in nine. The 1789 commune system was built on top of the medieval parish network — the saints never left. [Q-037]
- 🔥 35,014 communes, 32,764 unique names. 2,250 communes share their name with at least one other. Sainte-Colombe: 12 times. Saint-Aubin: 10. This is why every French address needs a département code. [Q-037]
- 🔥 The longest commune name in France is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, Marne). It exists because of the 1972 Loi Marcellin, which let merging communes keep both names. No one specified a length limit. [Q-039]
