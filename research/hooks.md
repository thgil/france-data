...
- 🔥 France has a commune called Y. One letter. 89 residents. In Somme. [Q-039]
- 🔥 11% of France's 35,014 communes start with "Saint." Saint-Martin leads with 203 variants — a direct trace of the cult of Martin of Tours spreading north from the Loire. [Q-037]
- 🔥 *Sainte-Colombe* appears 12 times across 12 different départements. Medieval saints couldn't trademark their villages. [Q-037]
- 🔥 The longest commune name in France is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne): 45 characters, three villages that merged but refused to disappear from the address book. [Q-039]
