...
- 🔥 France has a commune called Y. One letter. Population 89. Its name predates the Revolution by centuries. [Q-039]
- 🔥 Sainte-Colombe exists 12 times in 12 different départements — from Normandy to the Pyrenees. Same name, same saint, twelve villages that never agreed on which one got to keep it. [Q-037]
- 🔥 One in 8 French communes (4,437 of 35,014) contains "Saint" or "Sainte" in its name. The 1790 Revolution tried to remove the saints. It failed almost everywhere. [Q-037]
- 🔥 The longest commune name in France is 45 characters: Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson. It's a merged village — three historic communes, three names, zero editing. [Q-037]
