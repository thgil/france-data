...
- 🔥 France has a commune called Y. Population: 89. One letter. It's in the Somme and it's named for the shape of the river. [Q-039]
- 🔥 4,426 French communes are named after saints — one in eight. Creuse has nearly one in three (30.6%). Alsace has fewer than one in fifty (1.4%). [Q-037]
- 🔥 There are 12 communes in France called Sainte-Colombe. Each one is, officially, Sainte-Colombe. None is the Sainte-Colombe. [Q-037]
- 🔥 Corsica has 360 communes and exactly 2 saint names. The île de beauté is Catholic but doesn't name its villages like it. [Q-037]
