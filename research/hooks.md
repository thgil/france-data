...
- 🔥 There is a commune in France called Y. One letter. 89 residents. INSEE code 80829 in the Somme. The GPS does not believe it is a real place. [Q-039]
- 🔥 Sainte-Colombe exists twelve times in France — across twelve different départements. Each one has its own mayor. None of them are related. [Q-037]
- 🔥 3,882 French communes are named after a saint. That's 11.1% of all communes — more than one in nine. Saint-Martin alone gives its name to 202 villages. [Q-037]
- 🔥 France's longest commune name is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" — 45 characters, 7 hyphens, one Marne postman with strong opinions. The shortest is Y. [Q-039]
