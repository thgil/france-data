...
- Finding: Sainte-Colombe — 12 communes share this exact name, spread across 12 départements from Ardèche to Yonne. The runner-up is Saint-Sauveur (11×). Of the 15 most duplicated commune names, 11 begin with Saint- or Sainte-. The word "saint" appears 4,090 times across all 35,014 commune names — the single most common word in France's communal vocabulary. 3,882 communes (11.1%) begin with Saint- or Sainte-.
...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl)
- Finding: Y — a commune in the Somme (dept 80), population 89, INSEE code 80829, APL score 1.33 (a medical desert). It is the only single-letter commune in France. The two-letter club has 13 members: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. At the other end, the longest commune name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters), a merger of three former parishes.
- Story: [commune-names](/stories/commune-names/)
