...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — appearing 12 times in 12 different départements. Saint-Sauveur (11×), Saint-Aubin (10×), and Beaulieu (10×) follow. In total, 3,898 communes (11.1%) begin with Saint or Sainte, a direct imprint of medieval parish geography.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80), population 89 — one letter. Thirteen communes share the two-character tier: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters), a commune nouvelle from a 2016 merger.
- Story: [commune-names](/stories/commune-names/)
