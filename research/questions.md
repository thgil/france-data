...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* appears 12 times across 10 different départements — the most-duplicated exact name. But the broadest family is *Saint-Martin*, which has 202 distinct communes if you count all hyphenated variants (Saint-Martin-de-X, Saint-Martin-sur-Y, etc.). In total, 1,450 names are shared by two or more communes; 32,764 of 35,014 names are unique.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — a single letter — in the Somme (code 80829), population 89. The next shortest are 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. Most are very old settlements whose names predate standardised spelling. The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* in Marne at 45 characters.
- Story: [commune-names](/stories/commune-names/)
