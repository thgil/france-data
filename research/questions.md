...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe is the most-repeated exact commune name, appearing 12 times across different départements. Saint-Sauveur comes second (11×), Saint-Aubin third (10×). Of the 3,882 saint-prefixed communes, 3,376 bear unique names — most French communes named after a saint chose a saint nobody else used.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80, pop 89) — one letter, officially the shortest place name in the world per Guinness records. France also has 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters). Average commune name length: 11.8 characters.
- Story: [commune-names](/stories/commune-names/)
