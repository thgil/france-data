...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe*, appearing in 12 different départements, is the most duplicated exact commune name. Among saint-name bases, Saint-Martin leads with 202 communes, followed by Saint-Jean (155) and Saint-Pierre (144). Overall, 3,882 of 35,014 communes (11.1%) begin with "Saint" or "Sainte" — by far the largest single naming category in France.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80), population 89 — a single letter, probably pre-Roman in origin. 13 communes have two-letter names: Bû, By, Eu, Gy, Oô, Oz, Py, Ri, Ry, Sy, Ur, Us, Uz.
- Story: [saint-names](/stories/saint-names/)
