...
- Finding: Answered nationally rather than at commune level. Finistère (1,014 bars, under 1M residents) and tourism-heavy Mediterranean départements (Var 1,042, Hérault 1,013) punch clearly above their weight per capita. The overall picture — 49,385 active débits de boissons (NAF 56.30Z), with Nord+Pas-de-Calais (3,226 combined) edging Paris (3,120) for first place — is mapped in Story 4. Follow-up: joining bars.json (commune codes) with communes-apl.geojson (population) now enables per-capita rankings at commune level. Ski resorts dominate the top: Les Deux Alpes (202 bars/10k), Morzine (192/10k), Val-d'Isère (133/10k) due to tiny resident populations and massive tourist infrastructure.
- Story: [bars](/stories/bars/), cross-story: [last-bar](/stories/last-bar/)
