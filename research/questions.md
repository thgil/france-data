...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share the name. Saint-Sauveur has 11, Saint-Aubin and Beaulieu each have 10. In total, 1,450 names are shared by multiple communes, affecting 3,700 communes. One in nine communes (11.1%, 3,898 total) starts with Saint or Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (département 80, Somme) — one letter, 89 residents. Thirteen communes have two-letter names: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name: Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 letters, Marne, a merger of villages).
- Story: [commune-names](/stories/commune-names/)
