...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl), [DS-CONTOURS](datasets.md#ds-contours)
- Finding: Sainte-Colombe — 12 communes across 12 different départements share that name. Saint-Sauveur (11×) and Saint-Aubin / Beaulieu (10× each) follow. Across France, 1,450 distinct commune names are shared by multiple communes, accounting for 3,700 communes in total.
...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl), [DS-CONTOURS](datasets.md#ds-contours)
- Finding: Y (Somme, dept 80, pop 89) — just the single letter Y. The two-letter club has 13 members: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters), a merger of several hamlets that kept all their names.
- Story: [commune-names](/stories/commune-names/)
