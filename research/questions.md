...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: The most common exact full name is Sainte-Colombe, shared by 12 communes across 12 different départements. Saint-Sauveur (11), Saint-Aubin (10), and Beaulieu (10) follow. At the saint-prefix level, Saint-Martin is dominant with 202 variations (Saint-Martin-de-X, -sur-Y, etc.). 3,882 communes (11.1%) start with Saint or Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, INSEE code 80829) — one letter, 89 residents. Thirteen communes have two-letter names: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne) at 45 characters.
- Story: [commune-names](/stories/commune-names/)
