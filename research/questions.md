...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe appears 12 times across 12 separate départements, making it the most common commune name in France. Saint-Sauveur (11) and Saint-Aubin / Beaulieu (10 each) follow. 3,898 communes (11.1%) start with Saint or Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80, population 89) is the only one-letter commune in France. Its name derives from a Germanic root for water. There are 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz.
- Story: [commune-names](/stories/commune-names/)
