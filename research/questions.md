...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — exactly 12 communes with that exact name, spread across 12 different départements from Manche to Hautes-Alpes. All named for Columba of Sens, a 3rd-century martyr. Saint-Sauveur is the runner-up at 11. Among saint-prefixed variants (not exact matches), Saint-Martin leads with 202 communes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y, in the Somme (dept 80), population 89. One letter. Pre-Roman origin, possibly Gaulish. France also has 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson at 45 characters.
- Story: [commune-names](/stories/commune-names/)
