...
- Finding: **Sainte-Colombe** — 12 communes share the exact name, scattered from Gironde to Seine-Maritime. Saint-Sauveur comes second (11), followed by Saint-Aubin and Beaulieu (10 each). Overall, 3,898 of 35,014 communes (11.1%) start with "Saint" or "Sainte." The saint-name density is highest in Ardèche (29.0%), Creuse (28.2%), and Loire (27.8%).
...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl)
- Finding: **Y** — a single letter, in the Somme (dept 80), population 89. There are also 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, Marne, pop 491) — a 1972 loi Marcellin merger.
- Story: [name-game](/stories/name-game/)
