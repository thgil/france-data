...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, with 12 instances across 12 different départements. Saint-Sauveur is second (11×), then Saint-Aubin and Beaulieu (10× each). In total, 1,450 names are shared by more than one commune; 3,700 communes (10.6%) share their name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — one letter, INSEE code 80829, département 80 (Somme), population 89. Thirteen communes have names of two letters or fewer; Y is the only single-letter commune in France.
- Story: [commune-names](/stories/commune-names/)
