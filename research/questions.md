...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl) (commune names embedded in APL GeoJSON)
- Finding: Sainte-Colombe — appearing in 12 different départements. Saint-Sauveur is second at 11, Saint-Aubin and Beaulieu tied at 10. Of 35,014 communes, 32,764 have distinct names; 31,314 (89.4%) have a unique name. 4,437 communes (12.7%) carry a saint's name.
...
- Finding: Y (Somme, dept 80), population 89. One letter. Derives from Old Picard *i*, meaning water. There are also 13 two-letter communes including By, Eu, Gy, Oz, Ur, and 8 others. 888 communes have names of 4 characters or fewer.
- Story: [commune-names](/stories/commune-names/)
