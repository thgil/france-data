...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe is the most common exact commune name, appearing 12 times across 12 different départements. Saint-Sauveur (11×), Saint-Aubin (10×), and Beaulieu (10×) follow. Of 35,014 communes, 32,764 have unique names — 3,700 communes share a name with at least one other. The duplicate layer is almost entirely saint names from independent medieval parishes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (commune code 80829, Somme, pop. 89) is the only 1-letter commune in France. Its name derives from Old French for water (cf. Latin *aqua*), reflecting a now-drained pond. There are 13 communes with 2-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz), clustering in eastern and Pyrenean regions where pre-Romance naming survived. At the long end, Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 chars) holds the record — a product of the 1971 loi Marcellin commune-merger programme.
- Story: [commune-names](/stories/commune-names/)
