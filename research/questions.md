...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — appears 12 times across 11 différent départements. Runner-up is Saint-Sauveur (×11). In total 3,700 communes (10.6%) share their name with at least one other. Saint/Sainte prefixes alone account for 3,898 communes (11.1% of all). La Chapelle begins 152 commune names.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — one letter, Somme (dept 80), population 89, commune code 80829. Named from a Picard word for water. There are also 13 two-letter communes (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). Longest name: Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, Marne, result of a 1972 three-way merger).
- Story: [commune-names](/stories/commune-names/)
