...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe is the most-duplicated full commune name in France, appearing 12 times. By saint base, Saint-Martin leads with 202 communes, followed by Saint-Jean (155) and Saint-Pierre (144). 3,882 communes (11.1%) begin with Saint- or Sainte-. Dordogne has the most saint communes of any département (130).
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept. 80, pop. 89) is the only one-letter commune name in France. 13 communes have two-letter names: Sy (54 residents), By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters), a commune nouvelle formed by merger.
- Story: [commune-names](/stories/commune-names/)
