...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes across 12 different départements. Next are *Saint-Sauveur* (11), *Saint-Aubin* and *Beaulieu* (10 each). In total, 3,700 communes share a name with at least one other (10.6% of the total).
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — a single letter, commune code 80829 in the Somme, population 89. There are also 13 two-letter communes including Eu (Seine-Maritime, pop. 6,591) and Gy (Haute-Saône, pop. 1,001).
- Story: [commune-names](/stories/commune-names/)
