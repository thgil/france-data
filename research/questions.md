...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes across 12 different départements. Saint-Sauveur follows with 11, Saint-Aubin and Beaulieu with 10 each. Of France's 35,014 communes, 32,764 have unique names; 1,450 names are shared by 2 or more communes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single-letter commune in Somme (dept 80), population 89. There are 13 communes with two-letter names: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us — clustered in Normandy, Alsace, and the Pyrenees.
- Story: [commune-names](/stories/commune-names/)
