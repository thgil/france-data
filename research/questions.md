...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: The most common exact commune name is "Sainte-Colombe" (12 communes across 12 départements). Counter-intuitively, "Saint-Martin" does not appear in the top 25 — most Saint-Martin communes carry a disambiguation suffix. Overall, 3,980 communes (1 in 9) begin with Saint or Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" in Somme (code 80829) — one letter. There are also 15 two-character communes: Eu, Oz, Gy, Bô, Bû, By, Fa, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" (Marne, 45 characters).
- Story: [commune-names](/stories/commune-names/)
