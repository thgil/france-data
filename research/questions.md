...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share this exact name across 12 different départements. Saint-Sauveur is second (11), followed by Saint-Aubin and Beaulieu (10 each). The duplication reflects independent local toponymy: the same saint or geographic feature named a thousand times over.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single letter. Commune in the Somme (dept 80), population 89. The only one-letter commune name in France. 13 two-letter communes also exist: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. At the other end, Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters) is the longest.
- Story: [commune-names](/stories/commune-names/)
