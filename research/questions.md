...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes carry that name, spread across 12 different départements. Saint-Sauveur is second (11), Saint-Aubin and Beaulieu tied third (10 each). Of the 15 most-duplicated names, 13 begin with Saint or Sainte. Overall, 3,700 communes share their name with at least one other, out of 35,014 total.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single letter, population 89, in the Somme (dept 80). France has 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The largest two-letter commune is Eu (Seine-Maritime), population 6,591.
- Story: [place-names](/stories/place-names/)
