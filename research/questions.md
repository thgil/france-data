...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 separate communes in 12 different departments all bear this name. Saint-Sauveur follows with 11. The top names are dominated by saints and generic landscape terms (Beaulieu, Beaumont, Le Pin).
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single letter, 89 residents, Somme (dept 80). The only single-character commune name in France. 13 communes have two-letter names (Sy, By, Bû, Oô, …).
- Story: [commune-names](/stories/commune-names/)
