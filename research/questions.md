...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" is the most repeated commune name in France, appearing in 12 different départements (05, 17, 25, 33, 35, 40, 46, 50, 69, 76, 77, 89). "Saint-Sauveur" follows at 11. In total, 3,882 communes (11.1%) bear a saint's name. Of 35,014 communes, 31,314 have unique names; 1,450 names are shared by 2+ communes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" (code 80829, Somme, pop. 89) is the only 1-character commune in France. There are 13 two-character communes: Bû, By, Eu, Gy, Oô, Oz, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" (Marne, 45 chars, pop. 491) — a merger of three villages. Average commune name length is 11.8 characters.
- Story: [commune-names](/stories/commune-names/)
