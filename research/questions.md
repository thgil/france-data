...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes share this name across 12 different départements. The top 15 most-duplicated names are dominated by saint names (11 of 15). In total, 4,437 communes (12.7% of all 35,014) carry Saint or Sainte in their name.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80) — one character, population 89, INSEE code 80829. The name comes from Old French for water. There are 13 two-letter communes below it: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name in France is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne, 45 characters).
- Story: [commune-names](/stories/commune-names/)
