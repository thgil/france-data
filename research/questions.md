...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe is the most-repeated exact name (12 communes across 8 départements). Among prefixed saint names, Saint-Martin dominates with 202 communes. The full saint/sainte category covers 3,898 communes — 11.1% of all 35,014 in France.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, population 89) is a single letter — the shortest commune name in France and likely in the world. There are 14 communes with names of 2 characters or fewer. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 characters, Marne).
- Story: [commune-names](/stories/commune-names/)
