...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* is the most common, appearing in 12 different départements. *Saint-Sauveur* (11), *Saint-Aubin* and *Beaulieu* (10 each) follow. 11.1% of all 35,014 communes begin with *Saint* or *Sainte* (3,898 communes).
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80, pop 89) — a single letter, derived from the old Picard word for water. Thirteen communes have 2-letter names: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us.
- Story: [commune-names](/stories/commune-names/)
