...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, shared by 12 communes across 9 différents départements. Saint-Sauveur (11), Saint-Aubin (10), and Beaulieu (10) follow. Of France's 35,014 communes, 32,764 have unique names — 2,250 share their name with at least one other commune. The "Saint" prefix appears in 3,587 commune names; combined with "Sainte" (295), that's 3,898 communes (11.1%) named after a saint. The most common non-saint prefix: La Chapelle (147).
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — one letter, in the Somme (département 80), population 89. Thirteen communes share the two-letter record: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson in the Marne (45 characters, a 1972 merger artifact). Average commune name: 11.8 characters.
- Story: [commune-names](/stories/commune-names/)
