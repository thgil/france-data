...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Sainte-Colombe**, appearing in 12 different départements. Saint-Sauveur is second (11), Saint-Aubin and Beaulieu tied third (10 each). 11.1% of all communes are named after a saint (Saint- or Sainte-), and 3,700 communes share their name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Y** (Somme, dept 80), population 89 — a single letter, derived from the Germanic *aue* (water meadow). France also has 13 two-character communes: By, Sy, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. The longest is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters), the product of post-1970 merger policy.
- Story: [commune-names](/stories/commune-names/)
