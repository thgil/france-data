...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* is the most duplicated name — it appears in 12 separate communes across 12 different départements (Hautes-Alpes, Charente-Maritime, Doubs, Gironde, Ille-et-Vilaine, Landes, Lot, Manche, Rhône, Seine-Maritime, Seine-et-Marne, Yonne). Runner-ups: Saint-Sauveur (×11), Saint-Aubin (×10), Beaulieu (×10). Overall 1,450 name-groups have duplicates; 3,700 communes share their name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: The commune *Y* (Somme, dept 80, population 89) has the shortest official name in France — a single letter. There are 13 communes with 2-letter names: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest commune name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne, 45 characters).
- Story: [village-names](/stories/village-names/)
