...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes across 9 départements share this name. Saint-Sauveur comes second (11), then Saint-Aubin and Beaulieu (10 each). 3,891 communes (11.1%) start with Saint or Sainte, a direct sediment of medieval parish geography.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, pop. 89) — one letter, a record impossible to beat. Followed by 13 two-letter communes: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters), a 1972 merger of three villages.
- Story: [commune-names](/stories/commune-names/)
