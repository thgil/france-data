...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, with 12 instances across France. Among exact-match duplicates, it leads the table; Saint-Sauveur (11) and Saint-Aubin (10) follow. In total, 1,450 distinct names appear in two or more communes, affecting 3,700 communes (10.6% of the total). Saint prefix names dominate — independently chosen medieval parish dedications.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a one-letter commune in the Somme (INSEE code 80829), population 89. The name derives from Old French for water. Thirteen communes have two-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). The longest name in France is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 characters, Marne).
- Story: [commune-names](/stories/commune-names/)
