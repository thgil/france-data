...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes across 12 départements (Hautes-Alpes, Charente-Maritime, Doubs, Gironde, Ille-et-Vilaine, Landes, Lot, Manche, Rhône, Seine-Maritime, Seine-et-Marne, Yonne). France has 35,014 communes but only 32,764 unique names; 1,450 names are shared by at least two communes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80) — a single letter, population 89, with likely Norman roots from Latin *aqua*. France also has 13 two-character communes including *Eu, Gy, Oz, Oô, Uz, Us*. The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (45 chars, Marne), formed by a 1972 merger.
- Story: [commune-names](/stories/commune-names/)
