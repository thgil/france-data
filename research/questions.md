...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share this exact name, spread across 12 different départements (from Hautes-Alpes to Yonne), ranging from 59 to 1,953 residents. The top 15 most-common names are all saints: Saint-Sauveur (11), Saint-Aubin (10), Beaulieu (10), Saint-Marcel (9). 1,450 distinct names are used by more than one commune — 3,700 communes in total share a name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80, pop 89) — a single letter, derived from an old Picard word for water. There are also 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, 7 hyphens, Marne) — a commune nouvelle.
- Story: [commune-names](/stories/commune-names/)
