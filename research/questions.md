...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe (12 communes), Saint-Sauveur (11), Saint-Aubin (10), Beaulieu (10). Duplication is a feature of pre-Napoleonic local naming — the INSEE five-digit code silently disambiguates.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80), population 89. One letter. Thirteen communes have two-letter names: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, Marne), a 1972 merger of three communes.
- Story: [commune-names](/stories/commune-names/)
