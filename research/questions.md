...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* leads with 12 occurrences across 12 différents départements (05, 17, 25, 33, 35, 40, 46, 50, 69, 76, 77, 89). *Saint-Sauveur* appears 11 times; *Saint-Aubin* and *Beaulieu*, 10 times each. Of 35,014 communes, 3,587 begin with *Saint-* and 295 with *Sainte-*, representing 3,152 + 224 distinct saint names. 32,764 of the 35,014 communes have a unique name.
- Story: [name-game](/stories/name-game/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80, pop. 89) holds the record at one character — derived from a Picard word for water. There are 13 two-letter communes: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne, 45 characters), a 1972 fusion product. Average commune name length: 11.8 characters.
- Story: [name-game](/stories/name-game/)
