...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 different communes bear the name, scattered across 12 départements from Hautes-Alpes to Yonne. Saint-Sauveur (11×) and Saint-Aubin (10×) follow. Of 35,014 communes, 32,764 have unique names; the other 2,250 share a name with at least one other commune.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — one character, Somme (dept 80), population 89. Its name derives from Old French *y* meaning water, from a pre-Roman root. Below it, 13 communes have two-letter names including Eu (Seine-Maritime), Uz (Hautes-Pyrénées), and Oô (Haute-Garonne).
- Story: [commune-names](/stories/commune-names/)
