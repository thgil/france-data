...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, shared by 12 communes across 12 different départements. Saint-Sauveur appears 11 times, Saint-Aubin and Beaulieu 10 times each. 3,898 communes (11.1%) begin with Saint or Sainte; Saint-Martin leads with 202 communes. Of 35,014 communes, 32,764 carry unique names.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y, in the Somme (dept 80), with 89 residents — one letter long. 13 communes have two-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz), all pre-Latin or early Germanic survivors. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, Marne), result of a 1972 three-village merger.
- Story: [commune-names](/stories/commune-names/)
