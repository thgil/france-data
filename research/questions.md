...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe wins for exact match: 12 communes share that name. For prefix patterns, Saint-Martin is the champion with 203 variants (Saint-Martin-de-Belleville, Saint-Martin-de-Ré, etc.). 3,891 communes (11.1%) start with Saint or Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80, pop 89) is the only single-letter commune in France. There are 13 two-letter communes including Sy (Ardennes), By (Doubs), Oô (Haute-Garonne), Eu (Seine-Maritime), Gy (Haute-Saône). The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson at 45 characters (Marne).
- Story: [commune-names](/stories/commune-names/)
