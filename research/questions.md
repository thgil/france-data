...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" — 12 communes share this name across France, from Ain to Vosges. "Saint-Sauveur" (11×) and "Saint-Aubin" (10×) follow. Of 35,014 communes, only 32,764 names are unique; 2,250 names are shared by multiple communes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" — a single letter. It's a commune in the Somme (code 80829), population 89. France also has 13 two-letter communes (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz).
- Story: [commune-names](/stories/commune-names/)
