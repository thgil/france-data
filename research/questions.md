...
- Finding: Commune-level answer: Gavarnie-Gèdre (Hautes-Pyrénées) leads all communes with pop ≥ 200 at 20.5 bars/1,000; Les Deux Alpes (Isère) leads for pop ≥ 1,000 at 20.2/1,000. The top communes are almost all ski resorts — their bars serve winter-season tourist populations far larger than registered residents. At département level, Haute-Corse leads (2.11/1,000), not Bretagne (Finistère: 1.10/1,000). The Paris suburbs (Essonne, Yvelines, Hauts-de-Seine) are the driest in metropolitan France (0.31–0.37/1,000). 66.4% of communes have zero bars. National average: 0.73/1,000.
- Story: [bars](/stories/bars/) (dots map), [bar-deserts](/stories/bar-deserts/) (per-capita analysis)
