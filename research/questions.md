...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Sainte-Colombe** — 12 communes across 12 different départements all share this exact name. Runner-up: Saint-Sauveur (11×). 402 names are used by 3+ communes; 3,700 communes (10.6%) share their name with at least one other somewhere in France.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Y** — a one-letter commune in the Somme (dept 80, pop 89). Named from a Gaulish root meaning water or low ground. The 2-letter club has 13 members including Sy, By, Oô, Uz, Py, Ur, Eu, Gy. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 chars, Marne, pop 491), a 1972 merger of three villages.
- Story: [commune-names](/stories/commune-names/)
