...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share this name across 11 départements. Saint-Sauveur comes second (11), then Saint-Aubin and Beaulieu (10 each). Altogether 3,898 communes (11.1%) begin with Saint or Sainte. The full duplicate landscape is charted in Story 5.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single-letter commune in the Somme (dept 80, pop 89). The name dates to at least the 13th century and derives from a word for river or water. Below it: 13 two-letter communes including Eu, Us, Oz, Oô, and Py. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters, 7 hyphens).
- Story: [commune-names](/stories/commune-names/)
