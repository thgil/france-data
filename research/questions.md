...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes share this name, the highest of any commune name in France. Saint-Sauveur (11) and Saint-Aubin (10) follow. Of 35,014 communes, only 32,764 have unique names; 3,700 share a name with at least one other. Saint/Sainte prefixes account for 3,882 communes (11.1%). Saint-Martin is the most common saint, with 202 communes bearing his name.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — a one-letter commune in the Somme (dept 80), population 89. Name derived from a Picard word for a forking river. There are 13 communes with two-letter names (By, Bû, Eu, Gy, Oô, Oz, Py, Ri, Ry, Sy, Ur, Us, Uz). The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* in the Marne, at 45 characters.
- Story: [place-names](/stories/place-names/)
