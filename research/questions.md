...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — shared by 12 different communes across 12 different départements. Saint-Sauveur (11×) and Saint-Aubin (10×) follow. The most common name is also a saint name, fitting given that 11.1% of all French communes bear a saint's name. The names spread independently through the medieval parish network.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — one letter. Located in the Somme (dept 80), population 89, APL 2.78. There are also 13 two-letter communes (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). Most short names are pre-Latin place-name survivals from Basque, Catalan, or Gaulish roots.
- Story: [saint-republic](/stories/saint-republic/)
