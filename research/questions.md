...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes in 12 different départements share this exact name. Runner-up: *Saint-Sauveur* (11 communes), then *Saint-Aubin* and *Beaulieu* (10 each). In total, 1,450 distinct names are shared by 2+ communes, covering 3,700 communes. 11.1% of all French communes begin with *Saint* or *Sainte*.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — a commune in the Somme (dept 80), population 89, INSEE code 80829. Its name is a single letter, derived from an old Picard word for water. 13 other communes have 2-letter names (Eu, Oz, Ur, Py, Ry, Gy, Bû, By, Oô, Ri, Sy, Us, Uz). The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne, 45 characters).
- Story: [commune-names](/stories/commune-names/)
