...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, appearing 12 times across 9 différent départements. In all, 1,450 names are shared by more than one commune, and 3,700 communes share their name with at least one other place in France.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, département 80), population 89 — the only one-letter commune name in France. There are 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz.
- Story: [commune-names](/stories/commune-names/)
