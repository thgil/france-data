...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" is the most common exact commune name, appearing 12 times across 12 different départements (05, 17, 25, 33, 35, 40, 46, 50, 69, 76, 77, 89). "Saint-Sauveur" comes second at 11. Of 35,014 communes, only 32,764 have distinct names — 1,450 names are shared by 2+ communes.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" (Somme, dept 80, population 89) is the only one-letter commune in France. There are 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" (Marne, 45 characters).
- Story: [commune-names](/stories/commune-names/)
