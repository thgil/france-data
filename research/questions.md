...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" — it appears 12 times across 12 different départements (Hautes-Alpes, Charente-Maritime, Doubs, Gironde, Ille-et-Vilaine, Landes, Lot, Manche, Rhône, Seine-Maritime, Seine-et-Marne, Yonne). The top 5: Sainte-Colombe (12×), Saint-Sauveur (11×), Saint-Aubin (10×), Beaulieu (10×), Saint-Marcel (9×). France has 35,014 communes but only 32,764 distinct names.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" — one letter, département 80 (Somme), population 89. There are also 13 communes with 2-letter names: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" at 45 characters (Marne, pop. 491), the result of a 1972 merger. Average commune name length: 11.8 characters.
- Story: [commune-names](/stories/commune-names/)
