...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes across 12 different départements share the name. Saint-Sauveur (11×) and Saint-Aubin / Beaulieu (10× each) follow. Of 35,014 communes, 32,764 names are unique; 2,250 instances share their name with at least one other commune. 3,882 communes (11.1%) start with Saint- or Sainte-.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (commune code 80829, Somme, population 89) — one letter. 13 communes manage two letters: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 characters, Marne).
- Story: [commune-names](/stories/commune-names/)
