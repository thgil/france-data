...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Sainte-Colombe** — 12 communes share this name, spread across Ain, Ardèche, Côte-d'Or, Gers, Gironde, Maine-et-Loire (×2), Rhône, Savoie, Seine-Maritime, and Yonne. Saint-Sauveur is second with 11 occurrences. In total 3,700 communes (10.6%) share their name with at least one other commune in France.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Y** — a single letter, a commune in the Somme (code 80829), population 89. There are also 13 two-letter communes including Eu (Seine-Maritime, pop. 6,591) and Uz (Hautes-Pyrénées, pop. 36). The name Y likely derives from a Germanic root *ija* meaning "water."
- Story: [commune-names](/stories/commune-names/)
