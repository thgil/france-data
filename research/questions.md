...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* is the most duplicated exact name (12 communes). Among saint-name families, Saint-Martin leads with 202 variants. 3,891 of 35,014 communes (11.1%) carry a saint's name.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80, pop. 89) — one letter, the shortest commune name in France. Twelve communes have two-letter names (Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry). The longest is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* at 45 characters and 7 hyphens, a merger artifact.
- Story: [place-names](/stories/place-names/)
