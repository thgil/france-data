...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, shared by 12 communes across 12 different départements. Second is Saint-Sauveur (11×), then Saint-Aubin and Beaulieu tied at 10×. In total, 3,700 communes share their name with at least one other, out of 35,014 total.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y, in the Somme (code 80829), population 89. The only single-letter commune in France. The 13 two-letter communes include Oô (Haute-Garonne), Eu (Seine-Maritime), By (Doubs), and Uz (Hautes-Pyrénées).
- Story: [commune-names](/stories/commune-names/)
