...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl) (commune names + codes for 35,014 communes)
- Finding: "Sainte-Colombe" is the most common name — 12 communes share it. Saint-Sauveur is second (11), Saint-Aubin and Beaulieu tie at 10. 1,450 names are shared by two or more communes; 32,764 of 35,014 names are unique.
...
- Finding: "Y" (Somme, code 80829, population 89) is the only 1-character commune name in France. There are 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The longest name is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" (45 chars, Marne).
- Story: [commune-names](/stories/commune-names/)
