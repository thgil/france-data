...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe appears in 12 different départements — the most duplicated commune name in France. Saint-Sauveur follows with 11, then Saint-Aubin and Beaulieu at 10 each. Of 35,014 communes, only 32,764 names are unique; 1,450 names are shared by two or more communes, putting 2,250 communes in a naming collision.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a hamlet of 89 people in the Somme (dept 80, INSEE code 80829). The name derives from an Old Picard word for a small stream and has been in use since at least the 12th century. It is the only single-letter commune in France. Thirteen communes manage with two letters (Eu, By, Bû, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz).
- Story: [commune-names](/stories/commune-names/)
