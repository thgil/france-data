...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes across 12 différent départements share that exact name. Saint-Sauveur follows with 11, Saint-Aubin and Saint-Michel with 10 and 9. All top entries are saint names.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — a single-letter commune in the Somme (dept 80), population 89. The name derives from a Picard word for water. Thirteen communes have two-letter names.
- Story: [commune-names](/stories/commune-names/)
