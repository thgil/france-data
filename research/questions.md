...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 different communes in 12 different départements all share the name. Runner-up is Saint-Sauveur (11), followed by Saint-Aubin and Beaulieu (10 each). 32,764 distinct names for 35,014 communes; 3,700 communes share their name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — a commune in the Somme (dept 80) with 89 residents. Just one letter. The longest is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne, dept 51): 45 characters, 7 hyphens, population 491.
- Story: [commune-names](/stories/commune-names/)
