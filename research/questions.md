...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* appears 12 times — the most of any exact commune name — scattered across 12 departments with no two near each other. Runner-up: Saint-Sauveur (11×). Out of 34,969 communes there are only 32,719 unique names, meaning 2,250 are shared. Extracted from communes-apl.geojson (INSEE/Etalab 2025).
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept. 80), population 89, is France's — and probably the world's — shortest official municipal name at one letter. 13 communes have two-letter names: Eu, Uz, By, Gy, Ri, Oz, Py, Bû, Us, Sy, Ry, Ur, Oô. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 chars), a 2016 merger product.
- Story: [commune-names](/stories/commune-names/)
