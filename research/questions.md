...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" is the most-repeated exact name (12 communes). As a prefix, "Saint-Martin" leads with 202 communes beginning with that name — far ahead of Saint-Jean (155) and Saint-Pierre (144). 3,898 of 35,014 communes (11.1%) carry a Saint/Sainte prefix.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" in the Somme (dept 80, population 82) — one letter. France also has 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. Longest name: Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson in Marne (45 chars).
- Story: [commune-names](/stories/commune-names/)
