...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Sainte-Colombe** — 12 communes share this exact name across seven départements. Runner-up is Saint-Sauveur (11). Saint-Aubin and Beaulieu each appear 10 times. Of 35,014 communes, only 32,764 have unique names — about 2,250 share a name with at least one other commune.
- Story: [named-france](/stories/named-france/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: **Y** — one letter, in the Somme (dept 80), population 89. Likely derived from a Gaulish root (*ia*, water) worn to a single syllable. Plus 13 two-letter communes: Eu, Oz, Ur, Py, Uz, Gy, Ry, Us, By, Bû, Ri, Sy, Oô.
- Story: [named-france](/stories/named-france/)
