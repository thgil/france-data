...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes in 12 différent départements, from Manche to Rhône. Overall, 3,700 communes (10.6%) share a name with at least one other commune. 4,437 communes (12.7%) carry "Saint" or "Sainte". Saint-Martin leads patron saints with 202 communes. 89.4% of communes have a unique name.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — one letter, a village in the Somme (dept. 80), pop. 89. Answered as part of the place-names story.
- Story: [place-names](/stories/place-names/)
