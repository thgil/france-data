...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share this exact name, spread across 12 different départements (Hautes-Alpes, Charente-Maritime, Doubs, Gironde, Ille-et-Vilaine, Landes, Lot, Manche, Rhône, Seine-Maritime, Seine-et-Marne, Yonne). Combined population: 6,605. Saint-Sauveur (11×), Saint-Aubin (10×), and Beaulieu (10×) follow. Overall, 3,882 communes (11.1%) begin with Saint- or Sainte-.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80) — the only 1-letter commune in France, population 89. There are 13 communes with 2-letter names: By, Bû, Eu, Gy, Oô, Oz, Py, Ri, Ry, Sy, Ur, Us, Uz. At the other extreme, Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne) holds the longest name at 45 characters.
- Story: [commune-names](/stories/commune-names/)
