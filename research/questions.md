...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — it appears 12 times across France, scattered from Gironde to Haute-Saône. *Saint-Sauveur* (11×) and *Saint-Aubin* (10×) follow closely. Of 35,014 communes, 32,764 have unique names; 2,250 share their name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — one letter, population 89, in the Somme (dept. 80). Thirteen communes have two-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* at 45 characters (Marne, pop. 491). Average commune name: 11.8 characters.
- Story: [village-names](/stories/village-names/)
