...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes across 12 different départements. Saint-Sauveur (11), Saint-Aubin and Beaulieu (10 each) follow. Of 35,014 communes, only 32,764 have distinct names; 3,700 communes share their name with at least one other. 3,898 communes (11.1%) start with Saint- or Sainte-, generating most of the collisions.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — one letter, Somme (dept 80), population 89. France has 14 communes with names of 1–2 characters: Y, Eu, Ur, Us, Oz, Oô, By, Sy, Gy, Ri, Py, Ry, Bû, Uz. Most are Pyrenean or pre-French-language words. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (45 characters, Marne) — a merger relic.
- Story: [commune-names](/stories/commune-names/)
