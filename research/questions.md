...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, with 12 communes in 12 different départements (05 to 89). Runner-up: Saint-Sauveur (11). Of 35,014 communes, 32,764 have distinct names; 3,700 share a name with at least one other. The near-tie for most common names is always a saint.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80), pop 89 — a single letter, not an abbreviation. There are 13 two-letter communes: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us. The longest name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 chars, pop 491) — a merger of three communes that refused to lose any identity.
- Story: [commune-names](/stories/commune-names/)
