...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe is the most repeated full commune name (12 communes in 12 different départements). Among saint prefixes, Saint-Martin leads with 202 communes, followed by Saint-Jean (155) and Saint-Pierre (144). Altogether 3,882 communes (11.1%) begin with Saint or Sainte. 2,250 communes share their exact name with at least one other commune in France.
- Story: [what-is-y](/stories/what-is-y/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (commune 80829, Somme, pop. 89) holds the record at one letter. There are 13 two-letter communes: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz.
- Story: [what-is-y](/stories/what-is-y/)
