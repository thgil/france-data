...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — shared by 12 communes in 12 different départements. *Saint-Sauveur* is second (11), *Saint-Aubin* third (10). Of 35,014 communes, 3,700 (10.6%) share a name with at least one other, but only 1,450 distinct names are ever duplicated. 12.7% of all communes contain "saint" in their name.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y*, a village of 89 people in Somme (département 80, code 80829). One letter, official since at least the 13th century. France has 13 two-letter communes (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz) and 168 with three letters or fewer. The longest name is *Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson* (Marne, 45 characters).
- Story: [commune-names](/stories/commune-names/)
