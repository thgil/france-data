...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, with 12 communes bearing that exact name. Saint-Sauveur is second (11), Saint-Aubin and Beaulieu third (10 each). Of the top 20 most common names, 15 begin with Saint or Sainte. Overall 3,898 communes (11.1%) carry a saint's name. 1,450 distinct names are shared by more than one commune — 3,700 communes in total share their name with at least one other.
- Story: [place-names](/stories/place-names/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, pop. 89) — a single letter. France has exactly one 1-letter commune and 13 two-letter communes: By (Doubs), Bû (Eure-et-Loir), Eu (Seine-Maritime), Gy (Haute-Saône), Oz (Isère), Oô (Haute-Garonne), Py (Pyrénées-Orientales), Ri (Orne), Ry (Seine-Maritime), Sy (Ardennes), Ur (Pyrénées-Orientales), Us (Val-d'Oise), Uz (Hautes-Pyrénées). The longest commune name is Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson (Marne, 45 characters).
- Story: [place-names](/stories/place-names/)
