...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 communes across 12 different départements. Runner-up: Saint-Sauveur (11), Saint-Aubin and Beaulieu (10 each). Of 35,014 communes, 1,450 names are shared by 3,700 communes; 3,898 (11.1%) begin with Saint or Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* — one letter, Somme (dept 80), population 89, INSEE code 80829. Thirteen two-letter communes exist nationwide. Answered jointly with Q-037 in the commune-names story.
- Story: [commune-names](/stories/commune-names/)
