...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share this exact name across France. Among Saint-* names only, Saint-Sauveur tops the list at 11. Overall 3,882 communes (11.1%) start with "Saint" or "Sainte." Of 35,014 communes, only 32,764 have unique names; 3,700 communes share their name with at least one other.
- Story: [saint-everything](/stories/saint-everything/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single letter, in the Somme département (code 80829, population 89). Thirteen communes have two-letter names: By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz. The name "Y" derives from a pre-Latin root meaning a place near water; the river Noye runs through it.
- Story: [saint-everything](/stories/saint-everything/)
