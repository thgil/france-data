...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes in 12 different départements, with no disambiguation. 1,450 names total are shared by 2+ communes; 11.1% of all communes start with Saint/Sainte.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept. 80) — population 89, name traceable to at least the 12th century, possibly Gaulish root for "water". Thirteen communes have 2-letter names; Y alone has 1.
- Story: [commune-names](/stories/commune-names/)
