...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" appears 12 times across 12 différent départements — the most duplicated exact commune name. Among name components, "Saint-Martin" leads with 249 occurrences (32 départements), followed by Saint-Jean (169), Saint-Pierre (163), Saint-Germain (120). Overall 4,410 communes (12.6%) carry a saint's name.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" — a commune in the Somme (dept 80, pop 89). France's only one-letter commune. 13 communes have two-letter names (Bû, By, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). The longest name is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" at 45 characters (Marne, pop 491).
- Story: [commune-names](/stories/commune-names/)
