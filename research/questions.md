...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl), [DS-CONTOURS](datasets.md#ds-contours)
- Finding: Sainte-Colombe, shared by 12 communes across 11 departments. Saint-Sauveur (11) and Saint-Aubin (10) follow. 1,450 names are duplicated in total — 3,700 communes share a name with at least one other.
...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl), [DS-CONTOURS](datasets.md#ds-contours)
- Finding: Y — a commune in the Somme department (code 80829), population 89. The only one-letter commune in France. 13 communes have two-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz).
- Story: [commune-names](/stories/commune-names/)
