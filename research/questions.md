...
- Topic: [culture](topics/culture.md)
- Datasets: [DS-APL](datasets.md#ds-apl), [DS-CONTOURS](datasets.md#ds-contours)
- Finding: Sainte-Colombe is the single most duplicated exact name (12 communes across 12 départements), but it's a saint name like everything else. The real answer: Saint-Martin (249 communes) is the most common name where "saint" is the leading element. 4,424 communes (12.6%) carry saint/sainte somewhere in their name. 3,700 communes share a name with at least one other — and Y (pop. 89, Somme) is the shortest commune name in France.
...
- Finding: Y (code 80829, Somme, pop. 89) — one character. 13 two-letter communes follow: By, Sy, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us.
- Story: [commune-names](/stories/commune-names/)
