...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, appearing 12 times across France — every one a distinct commune in a different département, all named for the same 3rd-century martyr. Saint-Sauveur is second at 11, then Saint-Aubin and Beaulieu at 10 each. Of 35,014 communes, only 32,764 have unique names.
- Story: [saints-everywhere](/stories/saints-everywhere/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y, in the Somme (dept 80). One letter. Population 89. The inhabitants are called Ypsiloniens. France also has 13 two-letter communes: Gy, Us, Eu, Ri, Sy, Ry, Oz, Uz, Ur, Bû, Py, Oô, By — scattered across 10 différent départements.
- Story: [saints-everywhere](/stories/saints-everywhere/)
