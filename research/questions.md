...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — appearing 12 times across 12 different départements. Saint-Sauveur follows at 11, Saint-Aubin and Beaulieu at 10 each. 2,250 communes share their name with at least one other commune, in 1,450 collision groups.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a single letter, in the Somme (dept. 80), population 89. Derived from an old Picard root word for water. 13 two-letter communes also exist: Eu, Gy, Oz, Py, Ri, Ry, Sy, Ur, Us, Uz, By, Bû, Oô.
- Story: [commune-names](/stories/commune-names/)
