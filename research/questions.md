...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* — 12 different communes share this exact name, scattered from the Hautes-Alpes (pop. 59) to Seine-et-Marne (pop. 1,793). 1,450 names overall are shared by 2+ communes. See [commune-names](/stories/commune-names/)
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept. 80, pop. 89) — one letter, the shortest commune name in the world. 13 more communes have two-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). See [commune-names](/stories/commune-names/)
