...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Sainte-Colombe" — 12 communes, spread across 12 different departments from Normandy to the Pyrénées. Runner-up: "Saint-Sauveur" (11), "Saint-Aubin" and "Beaulieu" (10 each). Of 35,014 communes, only 32,764 have unique names; 3,700 communes share their name with at least one other.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" — a village of 89 people in the Somme (dept. 80), 1 character. Thought to derive from Old French for water. There are 13 communes with 2-letter names (Uz, Ri, Eu, Oz, Bû, Ry, Ur, Py, By, Oô, Gy, Sy, Us). The longest is "Saint-Remy-en-Bouzemont-Saint-Genest-et-Isson" at 45 characters.
- Story: [name-twins](/stories/name-twins/)
