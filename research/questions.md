...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe, with 12 communes sharing the name. Saint-Sauveur (11) and Saint-Aubin (10) follow. Of 35,014 communes, 3,700 (10.6%) share their name with at least one other commune, across 1,450 name groups.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80, pop 89) — a single letter, derived from the Latin aqua through Picard dialect. 13 two-letter communes also exist: Sy, By, Bû, Oô, Oz, Ri, Uz, Py, Ur, Gy, Eu, Ry, Us.
- Story: [commune-names](/stories/commune-names/)
