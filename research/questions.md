...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — repeated 12 times across France, from Gironde to Savoie. Saint-Sauveur is second (11), followed by Saint-Aubin and Beaulieu (10 each). Of 35,014 communes, 32,764 have unique names; 2,250 share their name with at least one other commune.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: "Y" — one letter, in the Somme (dept 80), 89 residents. Named from a Picard word for water. Thirteen more communes have 2-letter names: Bû, By, Eu, Gy, Oô, Oz, Py, Ri, Ry, Sy, Ur, Us, Uz.
- Story: [commune-names](/stories/commune-names/)
