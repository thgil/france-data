...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Sainte-Colombe* is the most-duplicated exact name, appearing 12 times across 12 différent départements. *Saint-Sauveur* appears 11 times; *Saint-Aubin* and *Beaulieu* 10 times each. In total, 4,272 commune names are shared by at least two communes — roughly one name in eight belongs to more than one place.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: *Y* (Somme, dept 80) — one character, population 89. It is the only 1-letter commune in France. Thirteen communes have 2-letter names, with the Pyrénées region producing the most (Py, Ur, Uz, all Pyrénées-Orientales / Hautes-Pyrénées).
- Story: [commune-names](/stories/commune-names/)
