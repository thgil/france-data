...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — it appears 12 times across 12 different départements. Saint-Sauveur (11) and Saint-Aubin / Beaulieu (10 each) follow. 1,450 distinct names are shared by 3,700 communes total; French addresses need the département code because the name alone is rarely unique.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y (Somme, dept 80, population 89) — one letter, officially. 13 more communes have 2-letter names (By, Bû, Eu, Gy, Oz, Oô, Py, Ri, Ry, Sy, Ur, Us, Uz). These are pre-Roman or Norse roots worn to stubs by centuries of phonetic attrition.
- Story: [commune-names](/stories/commune-names/)
