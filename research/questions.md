...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Sainte-Colombe — 12 communes share the name, spread across six departments. Saint-Sauveur (11) and Saint-Aubin (10) follow. Overall, 2,250 of France's 35,014 communes share a name with at least one other, leaving only 32,764 unique names.
...
- Status: ✅ answered
- Topic: [culture](topics/culture.md)
- Finding: Y — a village in the Somme (dept 80) with 89 residents and a single-letter name. The next shortest are 13 two-letter communes including Bû, Eu, Gy, Oô, and Uz (the smallest, with 36 residents).
- Story: [commune-names](/stories/commune-names/)
